...
# Читання тексту з файлу "стаття 2"
...
# Підрядки для пошуку
existing_substring = "сильно розгалудженим деревом пошуку"  # Існуючий підрядок стаття 2
...
print("Пошук Рабіна-Карпа:")
search_and_print(rabin_karp, text2, non_existing_substring)
